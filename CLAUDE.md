...
The blog is live again at `/blog` with four articles; the manual and talk
...
`/blog` and four articles under `src/pages/blog/` are live. **`src/data/blog.ts`
...
covers every retired URL — the 44 old blog posts (the four current articles are
