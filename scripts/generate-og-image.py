...
catalog_og_revisions = {
    ...
    "skill-getcolors-agent-network-package-agent-network-green": 3,
    "skill-getcolors-agent-network-package-agent-network-blue": 3,
    "source-getcolors-agent-network": 3,
    "skill-getcolors-clickstack-package-clickstack-red": 3,
    "skill-getcolors-clickstack-package-clickstack-green": 3,
    "skill-getcolors-clickstack-package-clickstack-blue": 3,
    "source-getcolors-clickstack": 3,
    "skill-getcolors-posthog-package-posthog-red": 3,
    "skill-getcolors-posthog-package-posthog-green": 3,
    "skill-getcolors-posthog-package-posthog-blue": 3,
    "source-getcolors-posthog": 3,
    # v3 on 2026-09-11 for the redis cards: the recipe now names AWS beside
    # Vultr and DigitalOcean and the S3 bucket beside R2.
    "skill-getcolors-redis-package-redis-green": 4,
    "source-getcolors-redis": 4,
    "skill-getcolors-agent-network-doks-package-agent-network-doks-red": 2,
    "skill-getcolors-agent-network-doks-package-agent-network-doks-blue": 2,
    "source-getcolors-agent-network-doks": 2,
    "skill-getcolors-agent-network-k8s-package-agent-network-k8s-red": 2,
    "skill-getcolors-agent-network-k8s-package-agent-network-k8s-green": 2,
    "skill-getcolors-agent-network-k8s-package-agent-network-k8s-blue": 2,
    "source-getcolors-agent-network-k8s": 2,
    "skill-getcolors-automq-package-automq-red": 4,
    "skill-getcolors-automq-package-automq-green": 4,
    "skill-getcolors-automq-package-automq-blue": 4,
    "source-getcolors-automq": 4,
    "skill-getcolors-skills-automq-multi-node": 3,
    "skill-getcolors-skills-clickhouse-replicated": 2,
    "skill-getcolors-clickhouse-package-clickhouse-red": 2,
    "skill-getcolors-clickhouse-package-clickhouse-green": 2,
    "skill-getcolors-clickhouse-package-clickhouse-blue": 2,
    "source-getcolors-clickhouse": 2,
    "skill-getcolors-dbos-package-dbos-red": 2,
    "skill-getcolors-dbos-package-dbos-green": 2,
    "skill-getcolors-dbos-package-dbos-blue": 2,
    "source-getcolors-dbos": 2,
    "skill-getcolors-k3s-package-k3s-red": 2,
    "skill-getcolors-k3s-package-k3s-green": 2,
    "skill-getcolors-k3s-package-k3s-blue": 2,
    "source-getcolors-k3s": 2,
    "skill-getcolors-langfuse-package-langfuse-red": 2,
    "skill-getcolors-langfuse-package-langfuse-green": 2,
    "skill-getcolors-langfuse-package-langfuse-blue": 2,
    "source-getcolors-langfuse": 2,
    "skill-getcolors-skills-n8n-single-node": 2,
    "skill-getcolors-n8n-package-n8n-red": 2,
    "skill-getcolors-n8n-package-n8n-green": 2,
    "skill-getcolors-n8n-package-n8n-blue": 2,
    "source-getcolors-n8n": 2,
    "skill-getcolors-neon-package-neon-red": 2,
    "skill-getcolors-neon-package-neon-green": 2,
    "skill-getcolors-neon-package-neon-blue": 2,
    "source-getcolors-neon": 2,
    "skill-getcolors-netbird-package-netbird-red": 2,
    "skill-getcolors-netbird-package-netbird-green": 2,
    "skill-getcolors-netbird-package-netbird-blue": 2,
    "source-getcolors-netbird": 2,
    "skill-getcolors-skills-redis-single-node": 2,
    "skill-getcolors-redis-package-redis-red": 2,
    "skill-getcolors-redis-package-redis-blue": 2,
    "skill-getcolors-restate-package-restate-red": 2,
    "skill-getcolors-restate-package-restate-green": 2,
    "skill-getcolors-restate-package-restate-blue": 2,
    "source-getcolors-restate": 2,
    "skill-getcolors-signoz-package-signoz-red": 2,
    "skill-getcolors-signoz-package-signoz-green": 2,
    "skill-getcolors-signoz-package-signoz-blue": 2,
    "source-getcolors-signoz": 2,
    "skill-getcolors-postgres-agy-package-postgres-agy-red": 2,
    "skill-getcolors-postgres-agy-package-postgres-agy-green": 2,
    "skill-getcolors-postgres-agy-package-postgres-agy-blue": 2,
    "source-getcolors-postgres-agy": 2,
    "skill-getcolors-postgres-ha-package-postgres-ha-red": 2,
    "skill-getcolors-postgres-ha-package-postgres-ha-green": 2,
    "skill-getcolors-postgres-ha-package-postgres-ha-blue": 2,
    "source-getcolors-postgres-ha": 2,
    "skill-getcolors-walter-package-walter-green": 2,
    "source-getcolors-walter": 2,
}
